...
export default function Page() {
    return (
        <>
            <Header />
            <Hero name="Checkout" />
            <section className="w-full lg:px-4 py-8 lg:max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-32">
                ...
                <div >
                    ...
                    <button className="h-[64px] w-[318px] border border-black  py-2 rounded-lg ml-16 "
                    >
                        Place order
                    </button>
                </div>
