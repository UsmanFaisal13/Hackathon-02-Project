                ...
                <section className="flex flex-col py-16 px-16 gap-8 ">
                    <div className='flex flex-col '>
                        ...
                        <div className="flex py-4 gap-8">
                            <div className="flex gap-2 items-center"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 className='py-4 font-medium text-3xl'>Going all-in with millennial design</h1>
                        <p className="py-4 lg:w-[817px] text-[15px] text-[#9f9f9f]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mus mauris vitae ultricies leo integer malesuada nunc. In nulla posuere sollicitudin aliquam ultrices. Morbi blandit cursus risus at ultrices mi tempus imperdiet. Libero enim sed faucibus turpis in. Cursus mattis molestie a iaculis at erat. Nibh cras pulvinar mattis nunc sed blandit libero. Pellentesque elit ullamcorper dignissim cras tincidunt. Pharetra et ultrices neque ornare aenean euismod elementum.</p>
                        <Link href={'/'}><button className='text-2xl font-medium border-b-2 border-black h-12 mt-8 pb-8'>Read More</button></Link>
                    </div>
                    <div className='flex flex-col '>
                        <div className="lg:w-[817px] h-[500px] bg-[url('/blog-2.png')] bg-center bg-cover bg-no-repeat">
