            ...
            <main className=" mb-80 lg:mb-0">
                <section className="w-full py-8 w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="md:col-span-2 rounded-lg lg:p-6 ">
                            <table className="w-full text-left ">
                                ...
                                <tbody>
                                    <tr>
                                        <td className="py-4 px-4 flex lg:flex-row flex-col items-center">
                                            <Image
                                                src="/asgaard.png"
                                                height={100}
                                                width={100}
                                        ...
                                        <td className="py-4 lg:px-4">Rs. 250,000.00</td>
                                        ...
                                        <td className="py-4 lg:px-4">Rs. 250,000.00</td>
                                        <td className="py-4 lg:px-4 text-center">
                                            <button>
