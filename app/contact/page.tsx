...
export default function Page() {
    return (
        <>
            <Header />
            <Hero name="Contact" />
            <section className="flex flex-col gap-4 justify-center items-center flex-wrap">
                ...
                <div className="pt-16 grid grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        <form className="w-full flex flex-col gap-4">
                            ...
                            <input type="text" className="border-2 border-[#9f9f9f] w-[527px] h-[75px] rounded-[10px]" />
                            ...
                            <input type="text" className="border-2 border-[#9f9f9f] w-[527px] h-[120px] rounded-[10px]" />
